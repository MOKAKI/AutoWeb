...
function AAAAAAAAAAAAAonClickChgiframeSrc()
{document.getElementById("AAAAAAAAAAAAAiframe").src = document.getElementById("AAAAAAAAAAAAAWebChgiframeSrc").value;}

function AAAAAAAAAAAAAc() {
    var r= new FileReader();
    var f=document.getElementById('AAAAAAAAAAAAAChgtextareaSrc').files[0];
    r.readAsText(f,"uft8");
    r.onload=function() {
        document.getElementById('AAAAAAAAAAAAAtextarea').value=this.result;
    };
}

function AAAAAAAAAAAAAdownload(){
    var text = document.getElementById("AAAAAAAAAAAAAtextarea").value;
    text = text.replace(/\n/g, "\r\n"); // To retain the Line breaks.
    var blob = new Blob([text], { type: "text/plain"});
    var anchor = document.createElement("a");
    anchor.download = " ";
...
<!-- /*AAAAAAAAAAAAA END */ --><!-- /*AAAAAAAAAAAAA END */ --><!-- /*AAAAAAAAAAAAA END */ -->
